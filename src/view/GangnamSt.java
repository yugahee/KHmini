...
public class GangnamSt extends JPanel{
	...
	GangnamSt(){
		...
		JLabel lk1 = new JLabel("강남역점");
		lk1.setLocation(30, 22);
		lk1.setSize(100, 20);
		lk1.setFont(new Font("굴림", Font.BOLD, 20));
		add(lk1);
		
		ImageIcon icon1 = new ImageIcon("image/store/gangnamSt.jpg");
		Image img1 = icon1.getImage();
		Image changeImg1 = img1.getScaledInstance(230, 120, Image.SCALE_SMOOTH);
		ImageIcon gangnamSt = new ImageIcon(changeImg1);

		JLabel ik1 = new JLabel(gangnamSt);
		ik1.setLocation(27, 50);
		ik1.setSize(245, 150);
		add(ik1);
		
		JLabel lk2 = new JLabel("서울 역삼동 858 강남역지하상가 E-37");
		...
		JLabel lk4 = new JLabel("강남 지하상가 E-37, 10번 11번 출구 사이");
		...
		JLabel lk8 = new JLabel("T멤버십, 카카오페이, 페이코");
