...
public class SeoulSt extends JPanel {
	...
	SeoulSt(){
		...
		JLabel lk1 = new JLabel("서울역점");
		lk1.setLocation(30, 22);
		lk1.setSize(100, 20);
		lk1.setFont(new Font("굴림", Font.BOLD, 20));
		add(lk1);
		
		ImageIcon icon1 = new ImageIcon("image/store/seoulSt.jpg");
		Image img1 = icon1.getImage();
		Image changeImg1 = img1.getScaledInstance(230, 135, Image.SCALE_SMOOTH);
		ImageIcon seoulSt = new ImageIcon(changeImg1);

		JLabel ik1 = new JLabel(seoulSt);
		ik1.setLocation(27, 35);
		ik1.setSize(245, 160);
		add(ik1);
		
		JLabel lk2 = new JLabel("서울 중구 한강대로 405, ktx역 b1");
		...
		JLabel lk4 = new JLabel("서울역 1번 출구 앞");
